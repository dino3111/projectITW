...
var vm = function () {
    ...
    self.toggleFavourite = function (id) {
        ...
        localStorage.setItem("favAthletes", JSON.stringify(self.favourites()));
    };
    self.SetFavourites = function () {
        let storage;
        try {
            storage = JSON.parse(localStorage.getItem("favAthletes"));
        } catch (e) {
            storage = [];
        }
...
const currentQueryString = new URLSearchParams(window.location.search);
    ...
    redirectToAthletes.href = `athletescards.html?page=${currentPage}&pagesize=${currentPageSize}`;
